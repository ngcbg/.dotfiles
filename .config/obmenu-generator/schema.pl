...
our $SCHEMA = [
	{sep => "NGC's Menu"},
    #          COMMAND                 LABEL                ICON
    {item => ['kitty',						                'Kitty',  	     'kitty']},
    {item => ['exo-open --launch FileManager',              'Thunarfm',      'file-manager']},
    {item => ['pcmanfm',                                    'Pcmanfm',       'pcmanfm']},
    {item => ['exo-open --launch WebBrowser ',              'Firefox',       'webbrowser-app']},
    {item => ['chromium',                                   'Chromium',      'chromium']},
	{pipe => ['audacious-control',      					'Audacious',     'stock_about']},
    {sep => "Applications"},
    ...
    {sep => "Places"},
    {pipe => ['obbrowser',					'Places',        'drive-harddisk']},
    {pipe => ['am-recent-files-pipemenu',   'Recent Files', 'folder-recent']},

    ## Custom advanced settings
    {sep => "Settings"},
        {sep => undef},
        {begin_cat => ['Display Temperature', 		'redshift']},
			{item => ['~/.bin/disptemp/mercury', 'Mercury',    'Mercury']},
			{item => ['~/.bin/disptemp/venus',   'Venus',      'Venus']},
			{item => ['~/.bin/disptemp/earth',   'Earth',      'Earth']},
			{item => ['~/.bin/disptemp/mars', 	 'Mars', 	   'Mars']},
			{item => ['~/.bin/disptemp/jupiter', 'Jupiter',    'Jupiter']},
			{item => ['~/.bin/disptemp/saturn',  'Saturn', 	   'Saturn']},
			{item => ['~/.bin/disptemp/uran', 	 'Uran', 	   'Uran']},
		{end_cat => undef},		
    {begin_cat => ['Preferences', 'theme']},
        ...
        {sep => undef},
        {pipe => ['ob-randr', 'Display settings', 'arandr']},
            # obmenu-generator
    ...
    {end_cat => undef},
		...
		{pipe => ['manjaro-polybar-pipemenu',      'Polybar',      'compton']},
    ...
    {sep => undef},
    {begin_cat => ['Help and Resources', 'theme']},
    ...
    {sep => "System"},
#    {item => ['systemctl suspend',                 'Suspend',	                     'Suspend']},
#    {item => ['systemctl hibernate',               'Hibernate',                      'Hibernate']},
#    {item => ['arcolinux-logout',              	   'Lock Screen',                    'lock']},
    {item => ['betterlockscreen -l dimblur',       'Lock Screen',                    'lock']},
